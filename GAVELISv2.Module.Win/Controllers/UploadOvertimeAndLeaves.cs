...
{
    public partial class UploadOvertimeAndLeaves : ViewController
    {
        private readonly SimpleAction _updateAction;
        public UploadOvertimeAndLeaves()
        {
            TargetObjectType = typeof(OvertimeAndLeave);
            TargetViewType = ViewType.ListView;
            _updateAction = new SimpleAction(this, "UploadOvertimeAndLeavesId", PredefinedCategory.RecordEdit)
            {
        ...
        {
            var frm = new UploadOvertimeAndLeavesForm(objectSpace, View.ObjectTypeInfo, Helper.GetCurrentCollectionSource(this), Application);
            frm.ShowDialog();
        }
