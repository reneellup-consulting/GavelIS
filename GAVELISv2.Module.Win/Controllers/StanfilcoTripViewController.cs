...
{
    public partial class StanfilcoTripViewController : ViewController
    {
        public StanfilcoTripViewController()
        {
            this.TargetObjectType = typeof(StanfilcoTrip);
            this.TargetViewType = ViewType.ListView;
            // StanfilcoTrip_ListView_Unprocessed
            this.TargetViewId = "StanfilcoTrip_ListView_Unprocessed";
