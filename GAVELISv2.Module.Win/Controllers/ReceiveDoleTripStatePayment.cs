...
{
    public partial class ReceiveDoleTripStatePayment : ViewController
    {
        private DolefilTripStatement doleTripStatement;
        private SimpleAction receiveDoleTripStatePayment;
        private NewObjectViewController newController;
        private DetailView payBillDetailView;
        public ReceiveDoleTripStatePayment()
        {
            this.TargetObjectType = typeof(DolefilTripStatement);
            this.TargetViewType = ViewType.DetailView;
            string actionID = string.Format("{0}.ReceivePayment", this.GetType()
            .Name);
            this.receiveDoleTripStatePayment = new SimpleAction(this, actionID, 
            PredefinedCategory.RecordEdit);
            this.receiveDoleTripStatePayment.Caption = "Receive Payment";
            this.receiveDoleTripStatePayment.Execute += new 
