...
namespace GAVELISv2.Module.Win.Controllers {
    public partial class RegisterCargo : ViewController {
        ...
        public RegisterCargo() {
            ...
            RegisterCargo_CustomizePopupWindowParams);
            this.registerCargo.Execute += new 
            PopupWindowShowActionExecuteEventHandler(RegisterCargo_Execute);
        }
        private void RegisterCargo_CustomizePopupWindowParams(object sender, 
        ...
        private void RegisterCargo_Execute(object sender, 
