...
{
    public partial class TireExpenseDetailsBufferDrillDownController : ViewController
    {
        private XafPivotGridControl _PivotGrid;
        private ListViewProcessCurrentObjectController processCurrentObjectController;
        public TireExpenseDetailsBufferDrillDownController()
        {
            TargetObjectType = typeof(TireExpenseDetailsBuffer);
        }
        ...
        void _PivotGrid_CellDoubleClick(object sender, DevExpress.XtraPivotGrid.PivotCellEventArgs e)
        {
            ...
            {
                string viewId = "TireExpenseDetailsBuffer_Drilled_ListView";
