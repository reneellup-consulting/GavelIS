...
{
    public partial class UploadCheckinCheckout : ViewController {
        private readonly SimpleAction _updateAction;
        public UploadCheckinCheckout() {
            TargetObjectType = typeof(CheckInAndOut);
            TargetViewType = ViewType.ListView;
            _updateAction = new SimpleAction(this, "UploadCheckinCheckoutActionId", PredefinedCategory.RecordEdit)
            {
        ...
        public void ShowUploadForm(IObjectSpace objectSpace){
            var frm = new UploadCheckinCheckoutForm(objectSpace, View.ObjectTypeInfo, Helper.GetCurrentCollectionSource(this), Application);
            frm.ShowDialog();
        }
