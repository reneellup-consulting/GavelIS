...
namespace GAVELISv2.Module.Win.Controllers {
    public partial class InvoiceDolefilTripAction : ViewController {
        private DolefilTrip dolefilTrip;
        private SimpleAction invoiceDolefilTripAction;
        private System.ComponentModel.BackgroundWorker _BgWorker;
        private ProgressForm _FrmProgress;
        public InvoiceDolefilTripAction() {
            this.TargetObjectType = typeof(DolefilTrip);
            this.TargetViewType = ViewType.DetailView;
            string actionID = string.Format("{0}.Invoice", this.GetType().Name);
            this.invoiceDolefilTripAction = new SimpleAction(this, actionID, 
            PredefinedCategory.RecordEdit);
            this.invoiceDolefilTripAction.Caption = "Invoice";
            this.invoiceDolefilTripAction.Execute += new 
            SimpleActionExecuteEventHandler(InvoiceStanfilcoTripAction_Execute);
            this.invoiceDolefilTripAction.Executed += new EventHandler<
            ActionBaseEventArgs>(InvoiceStanfilcoTripAction_Executed);
            this.invoiceDolefilTripAction.ConfirmationMessage = 
        ...
        SimpleActionExecuteEventArgs e) {
            ...
            _BgWorker.RunWorkerAsync(dolefilTrip);
        ...
        private void BgWorkerDoWork(object sender, DoWorkEventArgs e) {
            ...
            DolefilTrip _dolefil = (DolefilTrip)e.Argument;
            DolefilTrip thisTrip = session.GetObjectByKey<DolefilTrip>(_dolefil.
            Oid);
            try {
                ...
                if (index == 1) {
                    ...
                    _gjde1.DebitAmount = Math.Abs(thisTrip.NetBilling);
                    // Init validate trans balance
                    debitAmount = debitAmount + _gjde1.DebitAmount;
                    _gjde1.Description = "Dolefil Trip Invoice for Customer";
                    ...
                    _gjde2.Description = "Dolefil Trip Invoice for Customer";
                    ...
                    _gjde3.CreditAmount = Math.Abs(thisTrip.AmountTruck.Value);
                    // Init validate trans balance
                    creditAmount = creditAmount + _gjde3.CreditAmount;
                    _gjde3.Description = "Dolefil Trip Invoice for Customer";
                    ...
                    if (thisTrip.TrailerRental > 0) {
                        ...
                        _gjde4.Description = "Dolefil Trip Invoice for Customer"
                        ;
                    ...
                    //_gjde7.Description = "Dolefil Trip Invoice for Customer";
        ...
        private void UpdateActionState(bool inProgress) { 
            invoiceDolefilTripAction.Enabled.SetItemValue("Invoicing trip", !
            inProgress); }
