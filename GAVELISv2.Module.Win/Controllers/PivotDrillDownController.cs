...
{
    public partial class PivotDrillDownController : ViewController<ListView>
    {
        ...
        protected override void OnViewControlsCreated()
        {
            ...
            {
                if (View.ObjectTypeInfo.FullName == typeof(IncomeAndExpense02).FullName)
                {
        ...
        void pivotGrid_CellDoubleClick(object sender, PivotCellEventArgs e)
        {
            ...
            for (int i = 0; i < drillDown.RowCount; i++)
            {
                ...
                if (View.Id != "IncomeVer02_IncVers_Analysis" && obj != null && ((IncomeAndExpense02)obj).GMonth.ToString() == str)
                {
                    dCount++;
                    keysToShow1.Add(ObjectSpace.GetKeyValue(obj));
                }
                if (View.Id == "IncomeVer02_IncVers_Analysis" && str == "Expense" && obj != null && ((IncomeAndExpense02)obj).GMonth.ToString() == str2 && ((IncomeAndExpense02)obj).Expense != 0)
                {
                    dCount++;
                    keysToShow1.Add(ObjectSpace.GetKeyValue(obj));
                }
                if (View.Id == "IncomeVer02_IncVers_Analysis" && str == "Income" && obj != null && ((IncomeAndExpense02)obj).GMonth.ToString() == str2 && ((IncomeAndExpense02)obj).Income != 0)
                {
                    dCount++;
                    keysToShow1.Add(ObjectSpace.GetKeyValue(obj));
                }
            ...
            {
                string viewId = "IncomeAndExpense02_PivotDetails";
