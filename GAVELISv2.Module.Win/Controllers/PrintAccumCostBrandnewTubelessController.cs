...
{
    public partial class PrintAccumCostBrandnewTubelessController : ViewController
    {
        private SimpleAction printAccumCostBrandnewTubelessAction;
        private TireItemsAccomCostDetail accDetail;
        public PrintAccumCostBrandnewTubelessController()
        {
            this.TargetObjectType = typeof(TireItemsAccomCostDetail);
            this.TargetViewId = "TireItemsAccomulatedCost_Details_ListView";
            #region Print Calculated Attendance Sheet
            this.printAccumCostBrandnewTubelessAction = new SimpleAction(this, "PrintAccumCostBrandnewTubelessActionId",
            PredefinedCategory.RecordEdit);
            this.printAccumCostBrandnewTubelessAction.Caption = "Print BRANDNEW 11R22.5";
            this.printAccumCostBrandnewTubelessAction.Execute += new SimpleActionExecuteEventHandler(printAccumCostBrandnewTubelessAction_Execute);
            #endregion
        }
        void printAccumCostBrandnewTubelessAction_Execute(object sender, SimpleActionExecuteEventArgs e)
        {
            accDetail = this.View.CurrentObject as TireItemsAccomCostDetail;
            XafReport rep = new XafReport();
            string path = Directory.GetCurrentDirectory() + @"\Brandnew 11R22.5.repx";
