...
{
    public partial class PostDriverPayroll3Controller : ViewController
    {
        ...
        public PostDriverPayroll3Controller()
        {
            this.TargetObjectType = typeof(DriverPayrollBatch3);
            this.TargetViewType = ViewType.DetailView;
            string actionID = "DriverPayrollBatch3.PostDriverPayroll3";
    ...
    CurrentObject as DriverPayrollBatch3;
            ...
            _FrmProgress = new ProgressForm("Posting data...", _DriverPayrollBatch.DriverPayrolls3.Count,
"Data processed {0} of {1} ");
        ...
        private void BgWorkerDoWork(object sender, DoWorkEventArgs e)
        {
            ...
            XPCollection<DriverPayroll3> args = (XPCollection<DriverPayroll3>)e.Argument;
            DriverPayrollBatch3 batch = session.GetObjectByKey<DriverPayrollBatch3>(_DriverPayrollBatch.Oid);
            ...
            try
            {
                foreach (var item in args)
                {
                    ...
                    DriverPayroll3 pr = session.GetObjectByKey<DriverPayroll3>(item.Oid);
                    netpay += pr.NetPay;
                    if (pr.GrossPay > 0m)
                    {
                        int[] inds = null;
