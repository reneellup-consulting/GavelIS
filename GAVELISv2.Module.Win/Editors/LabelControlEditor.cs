...
{
    [PropertyEditor(typeof(string), "LabelControlEditor", false)]
    public class LabelControlEditor : WinPropertyEditor
    {
        public LabelControlEditor(Type objectType, IModelMemberViewItem model) : base(objectType, model) { }
