...
{
    [PropertyEditor(typeof(DateTime), "CustomDateTimeEditor2", false)]
    public class CustomDateTimeEditor2 : DatePropertyEditor
    {
        public CustomDateTimeEditor2(Type objectType, IModelMemberViewItem info) :
