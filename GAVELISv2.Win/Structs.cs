...
namespace GAVELISv2.Win
{
    ...
    class SSR_SMS
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = GAVELISv2.Win.UDisk.MAX_SSR_SMS_CONTENT_SIZE * 2 + 1)]
        public byte[] Content = new byte[GAVELISv2.Win.UDisk.MAX_SSR_SMS_CONTENT_SIZE * 2 + 1];//the content of the short message
    }
    ...
    class UDisk
    {
        ...
        *****************************************************************************************************************************/
           ...
           out string Name, out int Card, out int Group, out string TimeZone, out string PIN2)
        {
            ...
            GAVELISv2.Win.SSR_User ssruser = new GAVELISv2.Win.SSR_User();
            ssruser = (GAVELISv2.Win.SSR_User)Raw.RawDeserialize(DataBuf, typeof(GAVELISv2.Win.SSR_User));
            PIN = ssruser.PIN;
        ...
        *****************************************************************************************************************************/
        public void GetTemplateFromDat(byte[] DataBuf, out int Size, out int PIN, out int FingerID, out int Valid, out string Template)
        {
            ...
            GAVELISv2.Win.Templates9 tmp = new GAVELISv2.Win.Templates9();
            tmp = (GAVELISv2.Win.Templates9)Raw.RawDeserialize(DataBuf, typeof(GAVELISv2.Win.Templates9));
        ...
        *****************************************************************************************************************************/
        public void SetTmp10ToFp10(out byte[] DataBuf, int Size, int PIN, int FingerID, int Valid, string Template)
        {
            ...
            GAVELISv2.Win.Tmp10Header tmp10 = new GAVELISv2.Win.Tmp10Header();
            ...
            out string Status, out string Verified, out string Workcode)
        {
            ...
            for (i = Index; i < OneLogLength; i++)
            {
                if (DataBuf[i] == 9)//Ascii code 9 stands for the tab key on your keyboard.
                {
                    ...
                    PIN2 = System.Text.Encoding.Default.GetString(PIN2Buf).Trim();
                    Index = i;
                    break;
                }
            }
        ...
        *****************************************************************************************************************************/
        ...
        {
            byte[] ContentBuf = new byte[GAVELISv2.Win.UDisk.MAX_SSR_SMS_CONTENT_SIZE*2+1];

            GAVELISv2.Win.SSR_SMS sms = new GAVELISv2.Win.SSR_SMS();
            sms = (GAVELISv2.Win.SSR_SMS)Raw.RawDeserialize(DataBuf, typeof(GAVELISv2.Win.SSR_SMS));
            ...
            Array.Copy(DataBuf, 11, ContentBuf, 0, GAVELISv2.Win.UDisk.MAX_SSR_SMS_CONTENT_SIZE * 2 + 1);
        ...
        *****************************************************************************************************************************/
        public void GetUDataFromDat(byte[] DataBuf, out int PIN, out int SmsID)
        {
            ...
            GAVELISv2.Win.UData udata = new GAVELISv2.Win.UData();
            udata=(GAVELISv2.Win.UData)Raw.RawDeserialize(DataBuf,typeof(GAVELISv2.Win.UData));
