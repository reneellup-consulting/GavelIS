...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    [CreatableItem(false)]
    public class ShuntingSalesRegistry : BaseObject {
        private Guid _RowID;
        ...
        private TripLocation _PaidDestn;
        private TripLocation _Others;
        private decimal _NoKm;
        private decimal _ExcessKm;
        private decimal _AddlKm;
        ...
        [Custom("AllowEdit", "False")]
        [RuleRequiredField("", DefaultContexts.Save)]
        public TripLocation PaidDestn {
            get { return _PaidDestn; }
            set { SetPropertyValue("PaidDestn", ref _PaidDestn, value); }
        }
        [Custom("AllowEdit", "False")]
        [RuleRequiredField("", DefaultContexts.Save)]
        public TripLocation Others
        {
            get { return _Others; }
        ...
        public decimal NoKm {
            get { return _NoKm; }
            set { SetPropertyValue("NoKm", ref _NoKm, value); }
        }
        [Custom("AllowEdit", "False")]
        [Custom("DisplayFormat", "n")]
        public decimal ExcessKm {
            get { return _ExcessKm; }
            set { SetPropertyValue("ExcessKm", ref _ExcessKm, value); }
        }
        [Custom("AllowEdit", "False")]
        [Custom("DisplayFormat", "n")]
        public decimal AddlKm {
            get { return _AddlKm; }
            set { SetPropertyValue("AddlKm", ref _AddlKm, value); }
        }
        [PersistentAlias("NoKm + ExcessKm + AddlKm")]
        [Custom("DisplayFormat", "n")]
        public decimal TotalKm {
            get {
                object tempObject = EvaluateAlias("TotalKm");
        ...
        #endregion
        public ShuntingSalesRegistry(Session session): base(session) {
