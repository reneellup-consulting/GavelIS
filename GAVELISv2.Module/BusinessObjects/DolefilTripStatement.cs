...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    [CreatableItem(false)]
    public class DolefilTripStatement : XPObject {
        ...
        public void UpdateSelectedPayments(bool forceChangeEvent) {
            ...
            foreach (DolefilTripPayment detail in DolefilTripPayments) {
        ...
        public void UpdateDiscountAllowed(bool forceChangeEvent) {
            ...
            decimal tempTotal = 0m;
            foreach (DolefilTripCharge detail in DolefilTripCharges) {tempTotal 
        ...
        public XPCollection<DolefilTripCharge> DolefilTripCharges { get { return 
                GetCollection<DolefilTripCharge>("DolefilTripCharges"); } }
        [Aggregated,
        Association("DolefilTripStatement-DolefilTripPayments")]
        public XPCollection<DolefilTripPayment> DolefilTripPayments { get { 
                return GetCollection<DolefilTripPayment>("DolefilTripPayments"); 
            } }
        public DolefilTripStatement(Session session): base(session) {
        ...
        public override void AfterConstruction() {
            ...
            "Contains([Name], 'DOLE PHILIPPINES')"));
