...
namespace GAVELISv2.Module.BusinessObjects
{
    ...
    [CreatableItem(false)]
    public class AllUserInfoFromDevice : XPObject {
        private string _EnrolledNo;
        private string _EnrolledName;
        ...
        [Custom("AllowEdit", "False")]
        public string EnrolledName {
            get { return _EnrolledName; }
            set
            {
                SetPropertyValue<string>("EnrolledName", ref _EnrolledName, value);
            }
        }
        [Custom("AllowEdit", "False")]
        ...
        public AllUserInfoFromDevice(Session session)
            : base(session) {
