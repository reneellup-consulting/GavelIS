...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    public class AccountGeneralType : BaseObject {
        private const string defaultDisplayFormat = "{Code}->{Description}";
        private string _Code;
        private string _Description;
        private AccountTotalType _TotalType;
        ...
        [RuleRequiredField("", DefaultContexts.Save)]
        public AccountTotalType TotalType {
            get { return _TotalType; }
            set { SetPropertyValue("TotalType", ref _TotalType, value); }
        }
        ...
        #endregion
        public AccountGeneralType(Session session): base(session) {
