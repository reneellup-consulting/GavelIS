...
namespace GAVELISv2.Module.BusinessObjects
{
    ...
    public class SubExpenseType : BaseObject
    {
        private const string defaultDisplayFormat = "{Seq}->{Description}";
        private ExpenseType _MainType;
        private int _Seq;
        private string _Description;
        [Association("Expense-SubType")]
        public ExpenseType MainType
        {
            get
            {
                return _MainType;
            ...
            set
            {
                SetPropertyValue("MainType", ref _MainType, value);
            }
        }
        ...
        public int Seq
        {
            ...
            set
            {
                SetPropertyValue("Seq", ref _Seq, value);
            }
        }
        [RuleRequiredField("", DefaultContexts.Save)]
        ...
        public SubExpenseType(Session session)
            : base(session)
        {
