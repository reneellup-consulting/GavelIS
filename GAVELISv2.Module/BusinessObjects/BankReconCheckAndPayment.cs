...
namespace GAVELISv2.Module.BusinessObjects
{
    ...
    public class BankReconCheckAndPayment : XPObject
    {
        private Guid _RowID;
        private GenJournalHeader _BankReconID;
        ...
        public GenJournalHeader BankReconID
        {
            get { return _BankReconID; }
            set { SetPropertyValue("BankReconID", ref _BankReconID, value); }
        }
        [ImmediatePostData]
        public bool Select
        {
            ...
            set
            {
                ...
                if (!IsLoading)
                {
                    try
                    {
                        //((BankReconciliation)_BankReconID).UpdateCount(true);
                        //((BankReconciliation)_BankReconID).UpdateTotalDeposit(true);
                    }
                    catch (Exception) { }
                }
            }
        ...
        public BankReconCheckAndPayment(Session session)
            : base(session)
        {
