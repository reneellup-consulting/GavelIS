...
{
    public struct vIncExpForTruckingKey {
    ...
    [DefaultClassOptions]
    [Persistent("vIncExpForTrucking"), OptimisticLocking(false)]
    public class IncExpForTrucking : XPBaseObject
    {
        ...
        public IncExpForTrucking(Session session)
            : base(session)
        {
