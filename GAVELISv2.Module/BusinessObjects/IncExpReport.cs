...
{
    public struct vIncExpReportKey
    {
        // Category
    ...
    [DefaultClassOptions]
    [Persistent("vIncExpReport"), OptimisticLocking(false)]
    public class IncExpReport : XPBaseObject
    {
        [Key, Persistent, Browsable(false)]
        public vIncExpReportKey Key { get; set; }
        ...
        public IncExpReport(Session session)
            : base(session)
        {
