...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    public class CostCenter : BaseObject {
        ...
        private Employee _PersonResponsible;
        ...
        {
            get { return _IsStocking; }
            set { SetPropertyValue<bool>("IsStocking", ref _IsStocking, value); }
        }

        public FixedAsset FixedAsset {
            get { return _FixedAsset; }
            set { SetPropertyValue<FixedAsset>("FixedAsset", ref _FixedAsset, value); }
        }

        public Employee PersonResponsible {
            get { return _PersonResponsible; }
            set { SetPropertyValue<Employee>("PersonResponsible", ref _PersonResponsible, value); }
        }
