...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    [CreatableItem(false)]
    public class OtherTripStatement : XPObject {
        ...
        public void UpdateSelectedPayments(bool forceChangeEvent) {
            ...
            foreach (OtherTripPayment detail in OtherTripPayments) {tempTotal += 
        ...
        public void UpdateDiscountAllowed(bool forceChangeEvent) {
            ...
            decimal tempTotal = 0m;
            foreach (OtherTripCharge detail in OtherTripCharges) {tempTotal += 
        ...
        public void UpdateSelectedCharges(bool forceChangeEvent) {
            ...
            decimal tempTotal = 0m;
            foreach (OtherTripCharge detail in OtherTripCharges) {tempTotal += 
                detail.Pay ? detail.NetBilling : 0;}
        ...
        public XPCollection<OtherTripCharge> OtherTripCharges { get { return 
                GetCollection<OtherTripCharge>("OtherTripCharges"); } }
        [Aggregated,
        Association("OtherTripStatement-OtherTripPayments")]
        public XPCollection<OtherTripPayment> OtherTripPayments { get { return 
                GetCollection<OtherTripPayment>("OtherTripPayments"); } }
        public OtherTripStatement(Session session): base(session) {
