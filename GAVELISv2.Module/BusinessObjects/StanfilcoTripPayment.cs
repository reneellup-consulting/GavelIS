...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    public class StanfilcoTripPayment : BaseObject {
        ...
        public StanfilcoTripStatement StanfilcoTripStatementID {
            ...
            set { SetPropertyValue("StanfilcoTripStatementID", ref 
        ...
        public bool Select {
            ...
            set {
                ...
                if (!IsLoading) {
                    try {
                        _StanfilcoTripStatementID.UpdateSelectedPayments(true);
                    } catch (Exception) {}
                }
            }
        }
        ...
        #endregion
        public StanfilcoTripPayment(Session session): base(session) {
