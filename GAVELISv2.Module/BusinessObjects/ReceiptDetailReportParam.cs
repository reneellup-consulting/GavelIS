...
{
    //[NonPersistent]
    public class ReceiptDetailReportParam : ReportParametersObjectBase
    {
        public ReceiptDetailReportParam(Session session) : base(session) { }
        public override CriteriaOperator GetCriteria()
        {
            //string _start=string.Empty;
            //string _end=string.Empty;
            //string _customerNo=string.Empty;
        ...
        //[RuleValueComparison("", DefaultContexts.Save, ValueComparisonType.LessThanOrEqual, "@End")]
        ...
        //[RuleRequiredField("", DefaultContexts.Save)]
        //[RuleValueComparison("", DefaultContexts.Save, ValueComparisonType.GreaterThanOrEqual, "@Start")]
        public DateTime End
        {
            get
            {
