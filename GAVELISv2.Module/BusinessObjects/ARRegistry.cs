...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    [CreatableItem(false)]
    public class ARRegistry : XPObject {
        private Guid _RowID;
        ...
        private decimal _Amount; // Gross Total
        private decimal _AmtPaid; // Gross Total - Open Amount
        private decimal _AmtRmn; // Open Amount
        private int _DaysOt;
        ...
        #endregion
        public ARRegistry(Session session): base(session) {
