...
{
    public enum FuelPumpGroupByEnum
    {
        [DisplayName("Group by Unit")]
        GroupByUnit,
        [DisplayName("Group by Requestor")]
        GroupByRequestor
    }
    public class FuelPumpRegisterParam : ReportParametersObjectBase
    {
        private int _Year = DateTime.Now.Year;
        public FuelPumpRegisterParam(Session session) : base(session) { }
        ...
        [ImmediatePostData]
        public FuelPumpGroupByEnum GroupBy { get; set; }
        [ImmediatePostData]
