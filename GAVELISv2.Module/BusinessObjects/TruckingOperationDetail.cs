...
namespace GAVELISv2.Module.BusinessObjects
{
    ...
    public class TruckingOperationDetail : XPObject {
        private TruckingOperation _TOID;
        private TruckingOperationType _OperationType;
        ...
        public TruckingOperationType OperationType {
        ...
        public TruckingOperationDetail(Session session): base(session) {
