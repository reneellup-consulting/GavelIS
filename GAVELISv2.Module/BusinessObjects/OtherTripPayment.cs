...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    public class OtherTripPayment : BaseObject {
        ...
        public OtherTripStatement OtherTripStatementID {
            ...
            set { SetPropertyValue("OtherTripStatementID", ref 
        ...
        public bool Select {
            ...
            set {
                ...
                if (!IsLoading) {
                    try {
                        _OtherTripStatementID.UpdateSelectedPayments(true);
                    } catch (Exception) {}
                }
            }
        }
        ...
        #endregion
        public OtherTripPayment(Session session): base(session) {
