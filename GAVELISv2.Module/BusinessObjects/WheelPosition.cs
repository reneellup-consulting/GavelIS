...
namespace GAVELISv2.Module.BusinessObjects
{
    ...
    public class WheelPosition : XPObject
    {
        private const string defaultDisplayFormat = "{Code}->{Description}";
        private string _Code;
        private string _Description;
        //private FleetTypeEnum _FleetType;
        ...
        //    set { SetPropertyValue<FleetTypeEnum>("FleetType", ref _FleetType, value); }
        //}
        ...
        public WheelPosition(Session session)
            : base(session) {
