...
{
    public class FuelDailyPurchasesParam : ReportParametersObjectBase
    {
        public FuelDailyPurchasesParam(Session session) : base(session) { }
        public override CriteriaOperator GetCriteria()
        {
            ...
            if (_Vendor != null)
            {
                sbCrit.AppendFormat(" And [PurchaseInfo.Vendor.Code] = '{0}'", _Vendor.No);
            }
