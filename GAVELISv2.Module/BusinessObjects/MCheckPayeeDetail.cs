...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    public class MCheckPayeeDetail : BaseObject {
        private Guid _RowID;
        ...
        public MultiCheckVoucher CheckVoucher {
            ...
            set { SetPropertyValue("CheckVoucher", ref _CheckVoucher, value); }
        }
        ...
        #endregion
        public MCheckPayeeDetail(Session session): base(session) {
