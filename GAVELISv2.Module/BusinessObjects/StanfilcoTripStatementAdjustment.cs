...
namespace GAVELISv2.Module.BusinessObjects
{
    ...
    public class StanfilcoTripStatementAdjustment : XPObject
    {
        private Guid _RowID;
        private StanfilcoTripStatement _OwnerId;
        ...
        public StanfilcoTripStatement OwnerId
        {
            get { return _OwnerId; }
            set {
                StanfilcoTripStatement oldOwnerId = _OwnerId;
        ...
        public StanfilcoTripStatementAdjustment(Session session)
            : base(session)
        {
