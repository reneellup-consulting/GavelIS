...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    public class KDPayment : BaseObject {
        ...
        public KDStatement KDStatementID {
            ...
            set { SetPropertyValue("KDStatementID", ref _KDStatementID, value); 
            }
        }
        [ImmediatePostData]
        public bool Select {
            ...
            set {
                ...
                if (!IsLoading) {
                    try {
                        _KDStatementID.UpdateSelectedPayments(true);
                    } catch (Exception) {}
                }
            }
        }
        ...
        #endregion
        public KDPayment(Session session): base(session) {
