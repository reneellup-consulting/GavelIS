...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    [CreatableItem(false)]
    public class KDStatement : XPObject {
        ...
        public void UpdateSelectedPayments(bool forceChangeEvent) {
            ...
            foreach (KDPayment detail in KDPayments) {tempTotal += detail.Select 
                ? detail.AdjustNow : 0;}
        ...
        public void UpdateDiscountAllowed(bool forceChangeEvent) {
            ...
            decimal tempTotal = 0m;
            foreach (KDCharge detail in KDCharges) {tempTotal += detail.Pay ? 
                detail.Discount : 0;}
        ...
        public void UpdateGrossBilling(bool forceChangeEvent) {
            ...
            decimal tempTotal = 0m;
            foreach (KDCharge detail in KDCharges) {tempTotal += detail.GrossBilling;}
        ...
        public void UpdateWHTTotal(bool forceChangeEvent) {
            ...
            decimal tempTotal = 0m;
            foreach (KDCharge detail in KDCharges) {tempTotal += detail.
                WHTAmount;}
            _WHTTotal = tempTotal;
        ...
        public XPCollection<KDCharge> KDCharges { get { return GetCollection<
                KDCharge>("KDCharges"); } }
        [Aggregated,
        Association("KDStatement-KDPayments")]
        public XPCollection<KDPayment> KDPayments { get { return GetCollection<
                KDPayment>("KDPayments"); } }
        public KDStatement(Session session): base(session) {
