...
namespace GAVELISv2.Module.BusinessObjects
{
    ...
    [CreatableItem(false)]
    public class ItemMovementFreqAnalDetail : XPObject, IWithLineNumber
    {
        private Guid _RowID;
        private ItemMovementFreqAnalysis _HeaderId;
        ...
        public ItemMovementFreqAnalysis HeaderId
        {
        ...
        public ItemMovementFreqAnalDetail(Session session)
            : base(session)
        {
