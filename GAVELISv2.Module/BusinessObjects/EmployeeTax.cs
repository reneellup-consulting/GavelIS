...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    public class EmployeeTax : BaseObject {
        private const string defaultDisplayFormat = "{Code}->{Description}";
        private string _Code;
        private string _Description;
        private Account _EmployeeTaxCodeAccount;
        ...
        public Account EmployeeTaxCodeAccount {
            get { return _EmployeeTaxCodeAccount; }
            set { SetPropertyValue<Account>("EmployeeTaxCodeAccount", ref _EmployeeTaxCodeAccount, value); }
        }
        ...
        public EmployeeTax(Session session)
            : base(session) {
