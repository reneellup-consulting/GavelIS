...
namespace GAVELISv2.Module.BusinessObjects
{
    ...
    [CreatableItem(false)]
    public class DriverPayrollBatch3 : GenJournalHeader
    {
        ...
        public DriverPayrollBatch3(Session session)
            : base(session)
        {
        ...
        public void UpdateBatchTotal(bool forceChangeEvent)
        {
            ...
            foreach (DriverPayroll3 detail in DriverPayrolls3)
            {
