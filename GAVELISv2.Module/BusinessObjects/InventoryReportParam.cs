...
{
    //[NonPersistent]
    public class InventoryReportParam : ReportParametersObjectBase {
        public InventoryReportParam(Session session)
            : base(session) {
        }
        public override CriteriaOperator GetCriteria() {
            ...
            sbCrit.AppendFormat("[WarehouseLocation.Code] = '{0}'",_WarehouseLocation.Code);
