...
namespace GAVELISv2.Module.BusinessObjects
{
    ...
    [RuleCombinationOfPropertiesIsUnique("", DefaultContexts.Save, "MainId, Unit")]
    public class TruckIncomeExpenseTruck : XPObject
    {
        private Guid _RowID;
        ...
        #endregion
        public TruckIncomeExpenseTruck(Session session)
            : base(session)
        {
