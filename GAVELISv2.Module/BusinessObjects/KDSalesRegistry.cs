...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    [CreatableItem(false)]
    public class KDSalesRegistry : BaseObject {
        private Guid _RowID;
        ...
        private decimal _KDAmt;
        private decimal _FuelSub;
        ...
        [Custom("AllowEdit", "False")]
        [Custom("DisplayFormat", "n")]
        public decimal KDAmt {
            get { return _KDAmt; }
            set { SetPropertyValue("KDAmt", ref _KDAmt, value); }
        }
        [Custom("AllowEdit", "False")]
        [Custom("DisplayFormat", "n")]
        public decimal FuelSub {
            get { return _FuelSub; }
            set { SetPropertyValue("FuelSub", ref _FuelSub, value); }
        }
        [PersistentAlias("KDAmt + FuelSub")]
        [Custom("DisplayFormat", "n")]
        ...
        #endregion
        public KDSalesRegistry(Session session): base(session) {
