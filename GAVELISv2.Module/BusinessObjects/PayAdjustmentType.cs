...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    public class PayAdjustmentType : BaseObject {
        private const string defaultDisplayFormat = "{Code}->{Description}";
        private string _Code;
        private string _Description;
        private Account _PayAdjustmentAccount;
        ...
        public Account PayAdjustmentAccount {
            get { return _PayAdjustmentAccount; }
            set { SetPropertyValue<Account>("PayAdjustmentAccount", ref _PayAdjustmentAccount, value); }
        }
        ...
        public PayAdjustmentType(Session session)
            : base(session) {
