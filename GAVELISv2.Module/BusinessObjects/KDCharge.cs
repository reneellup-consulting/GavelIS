...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    public class KDCharge : XPObject {
        private KDStatement _KDStatementID;
        private KDEntry _KDEntryId;
        private int _Seq;
        private bool _Pay;
        ...
        [Association("KDStatement-KDCharges")]
        public KDStatement KDStatementID {
            get { return _KDStatementID; }
            set {
                KDStatement oldDocumentId = _KDStatementID;
                SetPropertyValue("KDStatementID", ref _KDStatementID, value);
                if (!IsLoading && !IsSaving && oldDocumentId != _KDStatementID)
                {
                    oldDocumentId = oldDocumentId ?? _KDStatementID;
                    try
                    {
        ...
        public KDEntry KDEntryId
        {
            get { return _KDEntryId; }
            set { SetPropertyValue("KDEntryId", ref _KDEntryId, value); }
        }
        [Custom("AllowEdit", "False")]
        public int Seq
        {
        ...
        public bool Pay {
            ...
            set {
                ...
                if (!IsLoading) {
                    try {
                        _KDStatementID.UpdateSelectedCharges(true);
                        _KDStatementID.UpdateDiscountAllowed(true);
                        _KDStatementID.UpdateFinCharges(true);
        ...
        public decimal GrossBilling {
            ...
            if (!IsLoading)
            {
                try
                {
                    _KDStatementID.UpdateGrossBilling(true);
                }
                catch (Exception) { }
            }
            }
        ...
        public decimal WHTAmount {
            ...
            if (!IsLoading)
            {
                try
                {
                    _KDStatementID.UpdateWHTTotal(true);
                }
                catch (Exception) { }
            }
            }
        ...
        #endregion
        public KDCharge(Session session): base(session) {
