...
namespace GAVELISv2.Module.BusinessObjects
{
    ...
    public class NetBillingCompSetup : XPObject
    {
        ...
        public XPCollection<NetBillingSetupDetail> NetBillSetupDetails
        {
            get
            {
                return
                    GetCollection<NetBillingSetupDetail>("NetBillSetupDetails");
            }
        }
        ...
        #endregion
        public NetBillingCompSetup(Session session)
            : base(session)
        {
