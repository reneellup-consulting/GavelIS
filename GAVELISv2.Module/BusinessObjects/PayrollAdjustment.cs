...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    public class PayrollAdjustment : XPObject {
        private Guid _RowID;
        ...
        public EmpIncentives EmpIncentiveId
        {
            get { return _EmpIncentiveId; }
            set { SetPropertyValue("EmpIncentiveId", ref _EmpIncentiveId, value); }
        }
        [RuleRequiredField("", DefaultContexts.Save)]
        ...
        #endregion
        public PayrollAdjustment(Session session): base(session) {
        ...
        private EmpIncentives _EmpIncentiveId;
        [NonPersistent]
        [Custom("AllowEdit", "False")]
