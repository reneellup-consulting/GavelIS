...
{
    public class ShuntingStatementReportParam : ReportParametersObjectBase
    {
        public ShuntingStatementReportParam(Session session) : base(session) { }
        public override CriteriaOperator GetCriteria()
        {
            ...
            // Date Range
            sbCrit.AppendFormat("Not [Status] In ('Paid') And [ExactEntryDate] >= #{0}# And [ExactEntryDateEnd] <= #{1}# And ", _Start.ToString("yyyy-MM-dd"), _End.AddDays(1).ToString("yyyy-MM-dd"));
            ...
            Console.WriteLine(sbCrit.ToString());
