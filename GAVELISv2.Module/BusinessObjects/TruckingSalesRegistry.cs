...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    [CreatableItem(false)]
    public class TruckingSalesRegistry : BaseObject {
        private Guid _RowID;
        ...
        private decimal _RateAdj;
        private decimal _TrailerRent;
        private FATrailer _TrailerNo;
        private decimal _TrailerIncome;
        ...
        [Custom("AllowEdit", "False")]
        [Custom("DisplayFormat", "n")]
        public decimal RateAdj {
            get { return _RateAdj; }
            set { SetPropertyValue("RateAdj", ref _RateAdj, value); }
        }
        [Custom("AllowEdit", "False")]
        [Custom("DisplayFormat", "n")]
        public decimal TrailerRent {
        ...
        [Custom("AllowEdit", "False")]
        [Custom("DisplayFormat", "n")]
        public decimal TrailerIncome {
            get { return _TrailerIncome; }
            set { SetPropertyValue("TrailerIncome", ref _TrailerIncome, value); 
            }
        }
        [Custom("AllowEdit", "False")]
        [Custom("DisplayFormat", "n")]
        ...
        [PersistentAlias("((TruckerPay + RateAdj) - TrailerRent) - Insurance")]
        [Custom("DisplayFormat", "n")]
        ...
        #endregion
        public TruckingSalesRegistry(Session session): base(session) {
