...
namespace GAVELISv2.Module.BusinessObjects
{
    ...
    [CreatableItem(false)]
    public class TripsIncomeExpenseReporter : XPObject
    {
        [NonPersistent]
        ...
        {
            get { return string.Format("{0:TIX00000000}", Oid); }
        }
        ...
        public Customer TripCustomer
        {
            ...
            set
            {
                SetPropertyValue("TripCustomer", ref _TripCustomer, value);
            }
        }
        ...
        [Association("TripsPerFuelGroups"), Aggregated]
        public XPCollection<TripsIerPerFuelGroup> TripsPerFuelGroups
        {
            get { return GetCollection<TripsIerPerFuelGroup>("TripsPerFuelGroups"); }
        }
        ...
        public TripsIncomeExpenseReporter(Session session)
            : base(session)
        {
