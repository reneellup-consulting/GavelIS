...
{
    public class DayToDayItemsRequesParam : ReportParametersObjectBase
    {
        private int _Year = DateTime.Now.Year;
        public DayToDayItemsRequesParam(Session session) : base(session) { }
        public override CriteriaOperator GetCriteria()
        {
            ...
            sbCrit.AppendFormat("[RequisitionInfo.EntryDate] >= #{0}# And [RequisitionInfo.EntryDate] <= #{1}#"
