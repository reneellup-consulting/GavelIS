...
namespace GAVELISv2.Module.BusinessObjects {
    ...
    public class OtherDeduction : BaseObject {
        private const string defaultDisplayFormat = "{Code}->{Description}";
        private string _Code;
        private string _Description;
        private Account _OtherDeductionAccount;
        ...
        public Account OtherDeductionAccount {
            get { return _OtherDeductionAccount; }
            set { SetPropertyValue<Account>("OtherDeductionAccount", ref _OtherDeductionAccount, value); }
        }
        ...
        public OtherDeduction(Session session)
            : base(session) {
