...
namespace GAVELISv2.Module.Editors {
    public interface IModelCustomUserControlViewItem : IModelViewItem { }
    [ViewItem(typeof(GAVELISv2.Module.Editors.IModelCustomUserControlViewItem))]
    public abstract class CustomUserControlViewItem : ViewItem, IComplexPropertyEditor {
        ...
        protected override void OnControlCreated() {
            ...
            new GAVELISv2.Module.Editors.XpoSessionAwareControlInitializer(Control as GAVELISv2.Module.Editors.IXpoSessionAwareControl, theObjectSpace);
        }
    }
    ...
    public class XpoSessionAwareControlInitializer {
        public XpoSessionAwareControlInitializer(GAVELISv2.Module.Editors.IXpoSessionAwareControl sessionAwareControl, IObjectSpace theObjectSpace) {
        ...
        public XpoSessionAwareControlInitializer(GAVELISv2.Module.Editors.IXpoSessionAwareControl sessionAwareControl, XafApplication theApplication)
